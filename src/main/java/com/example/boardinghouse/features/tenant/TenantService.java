...
import com.example.boardinghouse.features.tenant.dto.TenantRequest;
import com.example.boardinghouse.features.tenant.dto.TenantResponse;
...
public class TenantService {
    ...
    public TenantResponse updateTenant(Long id, TenantRequest request) {
        ...
        TenantProfile profile = tenantProfileRepository.findByUserId(user.getId())
                .orElseGet(() -> TenantProfile.builder().userId(user.getId()).build());
