package com.example.boardinghouse.features.invoices;

import com.example.boardinghouse.features.contracts.Contract;
import com.example.boardinghouse.features.contracts.ContractRepository;
import com.example.boardinghouse.features.invoices.dto.InvoiceCreateRequest;
import com.example.boardinghouse.features.invoices.dto.InvoiceResponse;
import com.example.boardinghouse.features.utility.UtilityRecord;
import com.example.boardinghouse.features.utility.UtilityRecordRepository;
...
public class InvoiceService {
    ...
    public InvoiceResponse createInvoice(InvoiceCreateRequest request) {
        ...
        if (!currentUtilityRecord.getRoomId().equals(contract.getRoomId())) {
        ...
        String invoiceCode = "INV-" + contract.getRoomId() + "-" + currentUtilityRecord.getRecordDate().getYear() + String.format("%02d", currentUtilityRecord.getRecordDate().getMonthValue());
